    ...
    <div className="min-h-screen cosmic-bg relative flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-4">
        <Card className="glass-card p-8 text-center animate-fade-in">
          ...
          <div className="flex items-center justify-center gap-2 text-sm text-accent mb-8">
          ...
          <Button
            ...
            className="w-full nebula-gradient text-white text-lg py-6 hover:opacity-90 transition-all duration-300"
          >
